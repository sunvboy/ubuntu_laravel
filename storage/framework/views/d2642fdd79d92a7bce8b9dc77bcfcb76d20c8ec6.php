<div class="mt-3">
    <div class="ibox-title">
        <div class="d-flex justify-content-between">
            <h5 class="form-label text-base font-semibold mb-0">
                Tối ưu SEO
                <small class=" text-danger">Thiết lập các thẻ mô tả giúp khách hàng dễ dàng tìm thấy bạn.</small>
            </h5>
            <div class="edit">
    ...
    <div class="ibox-content mt-3">
        ...
        <div class="seo-group d-none mt-3">
            <hr class="py-2">
            <div class="">
                <div class="form-row">
                    <div class="flex justify-between items-center">
                        ...
                        <span style="color:#9fafba;"><span id="titleCount"><?php echo !empty($detail->meta_title) ? strlen($detail->meta_title) : 0 ?></span>
                            trên 70 ký tự</span>
                    </div>
                    <?php
            ...
            <div class="mt-3">
                <div class="form-row">
                    <div class="flex justify-between items-center">
                        ...
                        <span style="color:#9fafba;"><span id="descriptionCount"><?php echo !empty($detail->meta_description) ? strlen($detail->meta_description) : 0 ?></span>
                            trên 320 ký tự</span>
                    </div>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/components/seo.blade.php ENDPATH**/ ?>