    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="d-flex justify-content-end p-3">
                ...
                <!-- Buttons with Label -->
                <a href="<?php echo e(route('category_products.create')); ?>" class="btn btn-primary btn-label waves-effect waves-light">
                        ...
                        <tr class="odd align-middle" id="post-<?php echo $v->id; ?>">
                            ...
                            <td class="text-end">
                                <div class="flex justify-center items-center">
                                    ...
                                    <a href="<?php echo e(route('category_products.edit',['id'=>$v->id])); ?>" class="btn btn-primary btn-label waves-effect waves-light">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/product/backend/category/index.blade.php ENDPATH**/ ?>