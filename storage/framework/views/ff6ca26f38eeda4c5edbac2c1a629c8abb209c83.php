                ...
                <div class="flex items-center justify-end">
                    <div class="item">
                        <div class="flex items-center space-x-1 h-full">
                            <img src="<?php echo e(asset('frontend/images/call_buy_img.png')); ?>" alt="icon hotline" class="mr-[2px]">
                            <div class="font-bold text-f16 ">
                                <span >Hotline</span>
                                <a href="tel:<?php echo e($fcSystem['contact_hotline']); ?>" class=""><?php echo e($fcSystem['contact_hotline']); ?></a>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/homepage/common/header.blade.php ENDPATH**/ ?>