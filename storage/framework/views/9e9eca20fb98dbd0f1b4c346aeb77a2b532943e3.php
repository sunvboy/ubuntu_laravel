         ...
         <div class="w-full md:w-3/4 px-[15px]">
            <div class="new-home-content new-home">
               <div class="title-title">
                  <h1 class="title-primary text-2xl font-semibold"><?php echo e($detail->title); ?><span class="icon"><img src="../frontend/images/iq.png" alt=""></span></h1>
               </div>
               <div class="mt-5">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/article/frontend/category/index.blade.php ENDPATH**/ ?>