    ...
    <div class="container px-4 mx-auto w-full flex flex-wrap items-center justify-between">
        <nav class="bg-grey-light w-full" aria-label="breadcrumb">
            <ol class="list-reset flex">
                ...
                <li><a href="javascript:void(0)" class="text-gray-500 hover:text-gray-600 text-f13"><?php echo e(trans('index.ContactInformation')); ?></a></li>
            </ol>
        </nav>
    </div>
</nav>
        ...
        <div class="mt-4 flex flex-col md:flex-row items-start md:space-x-4">
            ...
            <div class="flex-1 overflow-x-hidden shadowC rounded-xl w-full md:w-auto order-1 md:order-2">
                <div class="p-6 bg-white">
                    <h1 class="text-black font-bold text-xl"><?php echo e(trans('index.ContactInformation')); ?></h1>
                    <?php if(!$data->isEmpty()): ?>
                    <div>
                        <div class="mt-4">
                            <button class="flex font-extrabold text-red-500 text-h3 items-center" onclick="showModalAddress()">
                                ...
                                <span class="ml-2"><?php echo e(trans('index.AddNewAddress')); ?></span>
                            </button>
                        </div>
                                ...
                                <div class="section-address-item p-4 bg-white rounded-xl border border-gray-40">
                                    <div class="flex items-center justify-between">
                                        <span class="text-body text-black font-bold break-all">
                                            <?php echo e($item->name); ?>, <?php echo e($item->phone); ?>

                                        </span>
                                        <div>
                                            <button class="text-ui text-blue-500 font-bold ml-2 js_handle_edit" data-id="<?php echo e($item->id); ?>"> <?php echo e(trans('index.Edit')); ?> </button>
                                            <button class="text-ui text-red-500 font-bold ml-2 js_handle_delete" data-id="<?php echo e($item->id); ?>"> <?php echo e(trans('index.Delete')); ?> </button>
                                        </div>
                                    </div>
                                    <div class="mt-1 text-body font-normal">
                                        <span class="text-black">
                                            <?php echo e($item->address); ?> - <?php echo e($item->ward_name->name); ?> - <?php echo e($item->district_name->name); ?> - <?php echo e($item->city_name->name); ?>
                                    ...
                                    <div class="mt-1 text-xs">
                                        <span class="inline-block py-1 px-2 bg-blue-500 text-white rounded">
                                            <?php echo e(trans('index.DefaultAddress')); ?>
                        ...
                        <section class="pt-8 flex flex-col items-center">
                            <div class="max-w-screen-mobile">
                                <div class="flex flex-col items-center space-y-3">
                                    ...
                                    <span class="block text-body font-bold"><?php echo e(trans('index.NoAddress')); ?></span>
                                    <span class="text-sm">
                                        <?php echo e(trans('index.PleaseAddAddress')); ?>
                                ...
                                <button class="font-bold h-12 w-full text-white bg-global flex-1 cursor-pointer items-center inline-flex rounded-md px-6 justify-center text-[16px] mt-5" onclick="showModalAddress()">
                                    <?php echo e(trans('index.AddNewAddress')); ?>
    ...
    <div class="relative p-4 h-full md:h-auto w-[790px]">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form id="form-addAddress" class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="">
                <h3 class="text-black font-bold text-xl"><?php echo e(trans('index.AddressInformation')); ?></h3>
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-2 gap-6 mt-4">
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(trans('index.Fullname')); ?></label>
                    ...
                    <div>
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(trans('index.Phone')); ?></label>
                ...
                <div class="grid grid-cols-2 gap-6 mt-4">
                    <div>
                        <label for="cityID" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(trans('index.City')); ?></label>
                    ...
                    <div>
                        <label for="districtID" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(trans('index.District')); ?>
                    ...
                    <div>
                        <label for="wardID" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(trans('index.Ward')); ?></label>
                        <?php
                    ...
                    <div>
                        <label for="address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(trans('index.DeliveryAddress')); ?>
                ...
                <div class="flex items-center w-full mb-12">
                    <label for="toogleA" class="flex items-center cursor-pointer">
                        ...
                        <div class="ml-3 text-gray-700 text-sm">
                            <?php echo e(trans('index.SetDefaultAddress')); ?>
                ...
                <button type="submit" class="js_submit_address text-white bg-global hover:bg-rose-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-global dark:hover:bg-rose-600 dark:focus:ring-blue-800">
                    <?php echo e(trans('index.AddNewAddress')); ?></button>
            </form>
        </div>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/order/domains/order.tamphat.edu.vn/public_html/resources/views/customer/frontend/manager/address.blade.php ENDPATH**/ ?>