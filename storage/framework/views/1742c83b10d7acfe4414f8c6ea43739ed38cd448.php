...
<div class="main-out-list">
    <div class="row main-content-list-month">
        <div class="col-lg-12">
            <div class="card" id="invoiceList">
                <div class="card-header border-0">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0 flex-grow-1 fw-bold">Out List <?php echo e($dateEnd); ?></h5>
                ...
                <?php /*<form>
                    <input class="quyenTest" value="29" class="form-control">
                    <input class="quyenValueTest" value="29" class="form-control">
                    <button type="button" class="btn btn-danger btnQuyen">Thêm</button>
                </form>*/ ?>
                            ...
                            <table class="table align-middle table-nowrap" style="margin-bottom: 0;" id="invoiceTable">
                                <thead style="font-weight: bold;">
                                    <tr style="text-align: center; ">
                                        ...
                                        <td class="text-center text-uppercase" style="color: blue;background-color: #d1f0eb !important;color: #089d27;font-size: 15px;font-weight: bold;">
                                            Tổng<br>
                                            = <span class="totalEnforcement"></span>
                                        </td>
                                        <td style="color: blue; ">
                                        </td>
                                        <?php if(!empty($brands)): ?>
                                        ...
                                        <td style="color: purple; ">
                                            <?php echo e($brand->title); ?><br> = <span class="quantityOfBrand-<?php echo e($brand->id); ?>">0</span>
                                        </td>
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="textQuantityProduct-<?php echo e($item->id); ?>"><?php echo e($item->brand_product_carts->quantity); ?></span>
                                            <input type="hidden" class="quantity quantity-<?php echo e($item->id); ?>" value="<?php echo e($item->brand_product_carts->quantity); ?>">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" value="" style="border:0px;width: 50px;background: gray;color:white">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" class="inputTotalEndOld inputTotalEndOld-<?php echo e($item->id); ?>" value="<?php echo e(!empty($inputTotalEndOld)?$inputTotalEndOld:0); ?>">
                                        </td>
                                        <td>
            ...
            <?php echo $__env->make('brand.backend.brand-order.out-list-history', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!--end col-->
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/brand/backend/brand-order/out-list.blade.php ENDPATH**/ ?>