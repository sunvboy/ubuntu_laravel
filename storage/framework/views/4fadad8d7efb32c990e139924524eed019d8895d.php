                        ...
                        <td>
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in mr-2">
                                    <img class=" rounded-full" src="<?php echo e(File::exists(base_path($v->image)) ? asset($v->image) : asset('images/404.png')); ?>">
                                </div>
                                <div class="flex-1">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/article/backend/article/index.blade.php ENDPATH**/ ?>