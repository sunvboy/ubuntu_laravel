                            ...
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    ...
                                    <select class="form-control" data-placeholder="Search..." name="role_id[]" tabindex="-1">
                                        ...
                                        <option value="<?php echo e($v->id); ?>" <?php echo e((collect(old('role_id'))->contains($v->id)) ? 'selected':''); ?>>
                                            <?php echo e($v->title); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/user/backend/user/create.blade.php ENDPATH**/ ?>