                                ...
                                <div class="p-2 mt-4">
                                    <form action="<?php echo e(route('admin.login-store')); ?>" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="email" class="form-control" value="<?php echo e(old('email')); ?>" id="username" placeholder="admin@gmail.com">
                                        </div>
                                        <div class="mb-3">
                                            <div class="float-end">
                                                <a href="<?php echo e(route('admin.reset-password')); ?>" class="text-muted">Quên mật khẩu?</a>
                                            </div>
...
</html><?php /**PATH D:\xampp\htdocs\order.local\resources\views/user/backend/auth/login.blade.php ENDPATH**/ ?>