...
echo breadcrumb_backend($array, "Cập nhập trang");
?>
<?php $__env->stopSection(); ?>
<!--END: breadcrumb -->

<?php $__env->startSection('content'); ?>
<form role="form" action="<?php echo e(route('pages.update',['id' => $detail->id])); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row mt-3">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="mt-2">
                                <?php echo Form::select('page', config('page'), !empty(old('page')) ? old('page') : (!empty($detail->page) ? $detail->page : ''), ['class' => 'tom-select-field tom-select']); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/page/backend/edit.blade.php ENDPATH**/ ?>