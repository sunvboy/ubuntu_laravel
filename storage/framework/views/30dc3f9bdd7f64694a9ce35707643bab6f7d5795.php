...
?>
<?php $__env->stopSection(); ?>
<form role="form" action="<?php echo e(route('roles.update',['id' => $detailRole->id])); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="form-check col-lg-3">
                            <input name="permission_id[]" <?php echo e($permissionChecked->contains('id',$val->id) ? 'checked' : ''); ?> class="form-check-input" type="checkbox" value="<?php echo e($val->id); ?>" id="check<?php echo e($val->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/user/backend/role/edit.blade.php ENDPATH**/ ?>