...
<main class="main-home">
        ...
        <div class="container px-4 ">
            <div class="grid md:grid-cols-2 gap-8">
                <div class="flex flex-col justify-center items-center ">
                    ...
                    <a href="<?php echo e($routeDH); ?>" class="order-cart bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded neonShadow mt-10 js_order_2 ">
                ...
                <div class="flex flex-col justify-center items-center ">
                    ...
                    <a href="<?php echo e($routeDH); ?>" class="order-cart bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded neonShadow mt-10 js_order_5">
                        <?php echo e(trans('index.Order')); ?>
                    </a>
                </div>
            </div>
        ...
        <div class="container px-4">
            <div class="">
                <div class="title-title">
                    <h2 class="title-primary font-semibold"><?php echo e($fcSystem['title_1']); ?> <span class="icon"><img src="../frontend/images/iq.png" alt=""></span></h2>
                    <p class="text-f15 font-normal desc"><?php echo e($fcSystem['title_2']); ?></p>
                </div>
    ...
    <section class="pt-8 section-product">
        <div class="container px-4">
            <div class="flex items-center justify-between flex-col lg:flex-row space-y-4 lg:space-y-0">
               <div class="title-title">
                    <h2 class="title-primary font-semibold"><a href="<?php echo e(route('routerURL',['slug' => $item->slug])); ?>" class="text-f22 font-bold hover:text-[#3bb77e]"><?php echo e($item->title); ?></a><span class="icon"><img src="../frontend/images/iq.png" alt=""></span></h2>
    ...
    <section class="pt-8 new-home">
        <div class="container px-4">
            <div class="title-title">
                <h2 class="title-primary font-semibold"><a href="<?php echo e(route('routerURL',['slug' => $ishomeCategoryArticle->slug])); ?>" class="text-f22 font-bold"><?php echo e($ishomeCategoryArticle->title); ?></a><span class="icon"><img src="../frontend/images/iq.png" alt=""></span></h2>
            </div>
            ...
            <div class="mt-5">
                <div class="grid gap-5 md:grid-cols-4">
                    ...
                    <div class="hover-box ">
                        ...
                        <div class="nav-img">
                            <a href="<?php echo e(route('routerURL',['slug' => $item->slug])); ?>" class="text-f15 md:text-f18 font-bold leading-6 clamp-2 "><?php echo $item->title; ?></a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/homepage/home/index.blade.php ENDPATH**/ ?>