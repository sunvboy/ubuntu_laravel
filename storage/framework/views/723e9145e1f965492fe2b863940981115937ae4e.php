        ...
        <div class="mt-10 grid md:grid-cols-2 lg:grid-cols-4 gap-5 pb-8">
            <div class="text-f14">
                ...
                <div class="mb-4 flex items-center  mt-6" >
                    <img width="24" height="24" data-src="<?php echo e(asset('frontend/images/ad.png')); ?>" alt="<?php echo e($fcSystem['homepage_company']); ?>" class="lazy mr-[15px]">
            ...
            <div>
                <h4 class="font-semibold text-f17 mb-5 title-footer"><?php echo e(trans('index.CustomerSupport')); ?></h4>
                ...
                <div class="flex items-center mb-5">
                    <img width="24" height="24" data-src="<?php echo e(asset('frontend/images/icon-email.png')); ?>" alt="<?php echo e($fcSystem['homepage_company']); ?>" class="lazy mr-[15px]">
...
</div><?php /**PATH D:\xampp\htdocs\order.local\resources\views/homepage/common/footer.blade.php ENDPATH**/ ?>