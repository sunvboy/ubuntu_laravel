...
<main class="pb-8 main-category-product main-child">
        ...
        <div class="container">
            ...
            <nav class="bg-grey-light w-full" aria-label="breadcrumb">
                    <ol class="list-reset flex">
                        ...
                        <li><a href="<?php echo e(route('routerURL',['slug' => $item->slug])); ?>" class="text-gray-500 hover:text-gray-600 "><?php echo e($item->title); ?></a></li>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/product/frontend/category/index.blade.php ENDPATH**/ ?>