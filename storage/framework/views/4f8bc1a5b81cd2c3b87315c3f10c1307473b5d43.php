                        ...
                        <div class="accordion-item border-0">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body ms-2 ps-5 pt-0">
                                    <h6 class="mb-1"><?php echo e($item->note); ?></h6>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card-body">
                <ul class="list-unstyled mb-0 vstack gap-3">
                    <li>
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(asset('backend/assets/images/users/avatar-3.jpg')); ?>" alt="<?php echo e($detail->customer->name); ?>" class="avatar-sm rounded">
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <h6 class="fs-14 mb-1"><?php echo e($detail->customer->name); ?></h6>
                                <p class="text-muted mb-0"><?php echo e($detail->customer->code); ?></p>
                            </div>
                        </div>
                    </li>
                    <li><i class="ri-mail-line me-2 align-middle text-muted fs-16"></i><?php echo e($detail->customer->email); ?></li>
                    <li><i class="ri-phone-line me-2 align-middle text-muted fs-16"></i><?php echo e($detail->customer->phone); ?></li>
                </ul>
            </div>
        </div>
        <!--end card-->
        <?php if(!empty($detail->customer_addresses)): ?>
        <div class="card">
            <div class="card-header">
            ...
            <div class="card-body">
                <ul class="list-unstyled vstack gap-2 fs-13 mb-0">
                    <li class="fw-medium fs-14"><?php echo e($detail->customer_addresses->name); ?></li>
                    <li><?php echo e($detail->customer_addresses->phone); ?></li>
                    <li><?php echo e($detail->customer_addresses->address); ?></li>
                </ul>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <a href="<?php echo e(route('carts.index',['customer_id' => $detail->customer_id])); ?>" class="badge bg-primary-subtle text-primary fs-11">View all</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td><a href="<?php echo e(route('carts.show',['id'=>$item->id])); ?>"><?php echo e($data->firstItem()+$loop->index); ?></a></td>
                                    <td><a href="<?php echo e(route('carts.show',['id'=>$item->id])); ?>"><?php echo e($item->date_end); ?></a></td>
                                    <td><a href="<?php echo e(route('carts.show',['id'=>$item->id])); ?>"><?php echo e($item->cart_items->sum('quantity')); ?></a></td>
                                    <td><a href="<?php echo e(route('carts.show',['id'=>$item->id])); ?>"><?php echo e(number_format($subtotal+$tax,'0',',','.')); ?>đ</a></td>
                                    <td class="d-none">
                                        <a href="<?php echo e(route('carts.duplicate',['id'=>$item->id])); ?>" class="btn btn-primary btn-label waves-effect waves-light">
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/cart/backend/show.blade.php ENDPATH**/ ?>