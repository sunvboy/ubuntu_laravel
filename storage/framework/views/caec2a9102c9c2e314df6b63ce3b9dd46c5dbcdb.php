...
<script>
    ...
    $(document).on('click', '.full-search', function(e) {
        e.preventDefault();
        $('.filter-more').toggleClass('d-none');
        if ($('.filter-more').hasClass('filter-more-open')) {} else {
    ...
    $(document).on('click', '.ajax-delete-all-product', function() {
        let _this = $(this);
...
</script><?php /**PATH D:\xampp\htdocs\order.local\resources\views/product/backend/product/index/script.blade.php ENDPATH**/ ?>