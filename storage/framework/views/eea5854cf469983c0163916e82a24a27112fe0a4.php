...
<form role="form" action="<?php echo e(route('brands.update',['id' => $detail->id])); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row mt-3">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <div class="mt-3 d-none">
                            ...
                            <?php echo Form::select('parentid', $htmlCatalogue, $detail->parentid, ['class' => 'tom-select tom-select-field', 'data-placeholder' => "Select your favorite actors"]); ?>
                        </div>
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/brand/backend/brand/edit.blade.php ENDPATH**/ ?>