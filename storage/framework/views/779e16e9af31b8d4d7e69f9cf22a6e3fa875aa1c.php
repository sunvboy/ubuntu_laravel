...
<div class="content">
    ...
    <form action="" class="grid grid-cols-12 gap-2 mt-5" id="search" style="margin-bottom: 0px;">
        ...
        <div class="col-span-2 flex items-center space-x-2 justify-end">
            ...
            <a href="" class="btn btn-success text-white">Xuất Excel</a>
        </div>
    </form>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\evox.local\resources\views/order/backend/index.blade.php ENDPATH**/ ?>