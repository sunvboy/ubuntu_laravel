...
<div class="main-out-list">
    <div class="row main-content-list-month">
        ...
        <div id="outListData">
            <?php echo $__env->make('brand.backend.out-list.data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!--end col-->
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/brand/backend/out-list/index.blade.php ENDPATH**/ ?>