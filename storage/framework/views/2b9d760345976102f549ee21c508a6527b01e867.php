...
<div class="content">
    ...
    <div class=" grid grid-cols-12 gap-2 justify-between  mt-5 mb-5">
        ...
        <div class="col-span-12 flex justify-end">
            ...
            <a href="<?php echo e(route('products.create')); ?>" class="btn btn-primary shadow-md ml-2">Thêm mới</a>
        </div>
        <?php endif; ?>
        ...
        <a href="<?php echo e(route('products.export')); ?>" class="btn btn-primary shadow-md mr-2 col-span-2 hidden">Export excel</a>
    </div>
    <!-- START: tìm kiếm -->
