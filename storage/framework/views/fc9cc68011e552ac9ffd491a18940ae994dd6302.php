<div class="mt-3 <?php if (!in_array('tags', $dropdown)) { ?>hidden<?php } ?>">
    <div class="<?php if (!in_array('tags', $dropdown)) { ?>hidden<?php } ?>">
        <div class="flex justify-between">
            ...
            <div class="edit text-danger d-none">
                <a href="javascript:void(0);" data-tw-toggle="modal" data-tw-target="#myModal">Thêm mới</a>
            </div>
        </div>
        <select class="tom-select tom-select-tag" data-placeholder="Search..." data-header="Tags" multiple="multiple" name="tags[]" tabindex="-1" hidden="hidden">
            <?php if(isset($tags)): ?>
...
<!-- END: Modal Content -->
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/components/tag.blade.php ENDPATH**/ ?>