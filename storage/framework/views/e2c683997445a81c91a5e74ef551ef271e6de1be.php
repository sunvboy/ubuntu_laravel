...
<script>
    ...
    $(document).on('click', '.add-slide', function() {
        ...
        if (catalogueid == 0) {
            ...
            slideModal.find('.title_error').html('Nhóm slide là trường bắt buộc.');
        } else {
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/slide/backend/script.blade.php ENDPATH**/ ?>