...
echo breadcrumb_backend($array, "Thêm mới sản phẩm");
?>
<?php $__env->stopSection(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab4" role="tabpanel">
                            <?php echo $__env->make('product.backend.product.common.price',['action' => 'create'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div><!-- end card-body -->
                <div class="card-body">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div>
                            ...
                            <?php echo Form::select('catalogue_id', $htmlCatalogue, old('catalogue_id'), ['class' => 'tom-select tom-select-field', 'data-placeholder' => "Tìm kiếm danh mục...", 'required']); ?>
                        </div>
                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Chọn danh mục phụ</label>
                            <?php echo Form::select('catalogue[]', $htmlCatalogue, null, ['multiple', 'class' => 'tom-select tom-select-multiple', 'data-placeholder' => "Tìm kiếm danh mục..."]); ?>
                        </div>
                        <div class="mt-3 <?php if (!in_array('brands', $dropdown)) { ?>d-none<?php } ?>">
                            ...
                            <?php echo Form::select('brand_id', $htmlBrands, null, ['class' => 'tom-select tom-select-brand w-full', 'data-placeholder' => "Tìm kiếm thương hiệu..."]); ?>
                        </div>
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/product/backend/product/create.blade.php ENDPATH**/ ?>