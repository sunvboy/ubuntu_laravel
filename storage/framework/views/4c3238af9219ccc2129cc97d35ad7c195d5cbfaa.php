...
<form role="form" action="<?php echo e(route('category_products.store')); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row mt-3">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div>
                            ...
                            <?php echo Form::select('parentid', $htmlCatalogue, null, ['id' => 'select-beast', 'class' => 'tom-select tom-select-field', 'data-placeholder' => "Select your favorite actors"]); ?>
                        </div>
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/product/backend/category/create.blade.php ENDPATH**/ ?>