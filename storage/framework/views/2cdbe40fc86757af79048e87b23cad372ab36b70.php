...
<div class="">
    <div>
        <label class="form-label fw-bold">Bộ lọc sản phẩm</label>
    </div>
    <div class="ibox mb-5 block-version" data-countattribute_catalogue="<?php echo count($htmlAttribute) - 1 ?>">
        <div class="ibox-title">
            <div class="row">
                <div class="col-md-8">
                    <h5 class="mb-0">Chọn bộ lọc thuộc tính cho sản phẩm</h5>
        ...
        <div class="ibox-content mt-2" style="background: #f5f6f7; <?php echo (!empty($catalogue)) ? '' : 'display:none"' ?>">
            <div class="block-attribute">
                <div class="mb-3 overflow-x-auto">
                    <table class="table">
                        <thead>
                            <tr>
                                <td class="d-none">Sản phẩm biến thể</td>
                            ...
                            <?php if (isset($catalogue)) { ?>
                                <?php foreach ($catalogue as $key => $value) {
                                    if (isset($attribute_json[$key])) { ?>
                                        <tr data-id="<?php echo $value ?>" <?php echo (isset($checkbox[$key]) && $checkbox[$key] == 1) ? 'class="bg-choose align-middle"' : 'class="bg-choose align-middle"' ?>>
                                            <td class="d-none" data-index="<?php echo $key ?>">
                                                <?php if (isset($checkbox[$key]) && $checkbox[$key] == 1) { ?>
                                                    <input type="checkbox" checked name="checkbox[]" value="1" class="checkbox-item">
                                                    <input type="text" name="checkbox_val[]" value="1" class="d-none">
                                                    <div for="" class="label-checkboxitem checked"></div>
                                                <?php } else { ?>
                                                    <input type="checkbox" name="checkbox[]" value="1" class="checkbox-item">
                                                    <input type="text" name="checkbox_val[]" value="0" class="d-none">
                                            ...
                                            <td>
                                                ...
                                                <?php } else { ?>
                                                    <select name="attribute[<?php echo $key ?>][]" data-stt="<?php echo e($key); ?>" data-json="<?php echo (isset($attribute_json[$key])) ? base64_encode(json_encode($attribute_json[$key])) : '' ?>" data-condition="<?php echo $value ?>" class="form-control selectMultipe" multiple="multiple" data-title="Nhập 2 kí tự để tìm kiếm.." data-module="attributes">
                                                    </select>
                                                <?php } ?>
                                            </td>
                                            <td>
                ...
                <div class="flex " style="padding: 0px 20px 10px 20px;">
                    <a href="javascript:void(0)" class="add-variations btn btn-success mr-1 text-white d-none"><i class="fa fa-plus"></i> Tạo sản phẩm biến thể
                    </a>
                    ...
                    <?php if ($version > 0) { ?>
                        <?php foreach ($title_version as $key => $value) { ?>
                            <div class="mb-2 dd3-content">
                                ...
                                <div class="version_item_size d-none">
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">Mã sản phẩm</label><input type="text" name="code_version[]" value="<?php echo $code_version[$key] ?>" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                    ...
                                    <div class="mt-3">
                                        <h2 class="fw-bold" style="font-size: 16px;">Quản lý tồn kho</h2>
                                        <div class="mt-3">
                                            <div class="">
                                        ...
                                        <div class="showStock @if($_stock_status[$key]==0) d-none @endif">
                                            <div class="mt-3">
...
</div><?php /**PATH D:\xampp\htdocs\order.local\resources\views/product/backend/product/common/attribute.blade.php ENDPATH**/ ?>