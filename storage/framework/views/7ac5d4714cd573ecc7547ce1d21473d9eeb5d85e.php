...
<main class="pb-8 main-product-detail main-child">
      ...
      <div class="container">
         ...
         <nav class="bg-grey-light w-full" aria-label="breadcrumb">
            <ol class="list-reset flex">
               ...
               <li><span class="text-gray-500 mx-2">/</span></li>
               <li><a href="<?php echo route('routerURL', ['slug' => $detail->slug]) ?>" class="text-[#3bb77e] hover:text-green-500  "><?php echo e($detail->title); ?></a></li>
            </ol>
         </nav>
      </div>
   </section>
   <div class=" container mx-auto px-4">
         ...
         <div class="col-span-1 md:col-span-12 lg:col-span-9">
            <div class="grid grid-cols-1 md:grid-cols-12 space-y-8 md:space-y-0 md:gap-8">
               ...
               <div class="col-span-1 md:col-span-6 lg:col-span-6">
                  <h1 class="title-product"><?php echo e($detail->title); ?></h1>
         ...
         <div class="col-span-1 md:col-span-6 lg:col-span-3 ">
            ...
            <div class="mt-5">
               <div class="title-title">
                  <h2 class="title-primary font-semibold"><?php echo e($ishomeCategoryArticle->title); ?><span class="icon"><img src="../frontend/images/iq.png" alt=""></span></h2>
               </div>
               <div class="space-y-4">
      ...
      <section class="mt-8 Other-product">
         <div class="title-title">
            <h2 class="title-primary font-semibold"><?php echo e(trans('index.RelatedProducts')); ?><span class="icon"><img src="../frontend/images/iq.png" alt=""></span></h2>
         </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/product/frontend/product/index.blade.php ENDPATH**/ ?>