...
<form role="form" action="<?php echo e(route('config_colums.store')); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <?php echo Form::text('keyword', '', ['class' => 'form-control']); ?>
                    </div>
                    <div class="mt-3">
                            ...
                            <div id="schedule">
                                ...
                                <div class="mt-2 desc-more position-relative">
                                    <div class="row">
                                        ...
                                        <button class="btn btn-danger text-white delete-attr position-absolute" type="button" style="right:0px;top: 50%;transform: translateY(-50%);width: 50px;height: 38px;display: flex;justify-content: center;align-items: center;"><i data-lucide="trash-2" class="w-4 h-4"></i></button>
                                    </div>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\order.local\resources\views/config/colums/create.blade.php ENDPATH**/ ?>