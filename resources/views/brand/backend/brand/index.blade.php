    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="d-flex justify-content-between p-2">
                ...
                @can('brands_create')
                <!-- Buttons with Label -->
                <a href="{{route('brands.create')}}" class="btn btn-primary btn-label waves-effect waves-light">
                ...
                <table class="table table-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr class="odd align-middle" id="post-<?php echo $v->id; ?>">
                            ...
                            <td class="text-end">
                                @can('brands_edit')
                                <a href="{{ route('brand_orders.index',['id'=>$v->id]) }}" class="btn btn-success btn-label waves-effect waves-light">
                                    <i class="ri-add-fill label-icon align-middle fs-16 me-2"></i> Xem đơn cần nhập
                                </a>
                                @endcan
                                @can('brands_edit')
                                <a href="{{ route('brands.edit',['id'=>$v->id]) }}" class="btn btn-primary btn-label waves-effect waves-light">
