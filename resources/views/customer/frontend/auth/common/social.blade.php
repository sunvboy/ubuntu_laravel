<div class="flex gap-2 lg:gap-4 md:gap-4 sm:gap-4 flex-row justify-center">
    <a href="{{ route('customer.redirect',['provider' => 'facebook']) }}" class="uppercase h-12 text-black w-full rounded bg-white hover:bg-indigo-100 flex items-center gap-1 lg:gap-3 md:gap-3 sm:gap-3 justify-center">
    ...
    <a href="{{ route('customer.redirect',['provider' => 'google']) }}" class="uppercase h-12 text-black w-full rounded bg-white hover:bg-indigo-100 flex items-center gap-1 lg:gap-3 md:gap-3 sm:gap-3 justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 48 48" style=" fill:#000000;">
    ...
    <a href="{{ route('customer.redirect',['provider' => 'zalo']) }}" class="uppercase h-12 text-black w-full rounded bg-white hover:bg-indigo-100 flex items-center gap-1 lg:gap-3 md:gap-3 sm:gap-3 justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 48 48" style=" fill:#000000;">
