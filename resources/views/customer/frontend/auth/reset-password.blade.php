    ...
    <div class="container px-4 mx-auto w-full flex flex-wrap items-center justify-between">
        <nav class="bg-grey-light w-full" aria-label="breadcrumb">
            <ol class="list-reset flex">
                ...
                <li><a href="javascript:void(0)" class="text-gray-500 hover:text-gray-600 text-f13">{{trans('index.ForgotPassword')}}</a></li>
            </ol>
        </nav>
    </div>
</nav>
            ...
            <div class="w-[580px] max-w-full bg-[#f4f6f8] p-6 rounded-xl">
                ...
                <form action="" method="POST" id="form-auth">
                    ...
                    <div class="mt-5 flex justify-center">
                        <button id="submit-auth" type="submit" class="btn-submit-contact py-4 px-1 md:px-8 rounded-lg block bg-[#3bb77e]  text-white transition-all leading-none text-f15 font-bold">{{trans('index.ForgotPasswordSend')}}</button>
