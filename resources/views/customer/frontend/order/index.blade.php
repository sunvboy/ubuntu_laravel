                                    ...
                                    <div class="bg-[#f3eedf67] py-2 float-left w-full">
                                        <div class="p-2">
                                            ...
                                            <div class="mt-3 flex space-x-2 justify-between md:justify-end">
                                                ...
                                                <a href="{{route('customer.copyOrder',['id' => $item->id])}}" class="text-xs float-right font-bold h-9 leading-9  text-white bg-green-600 cursor-pointer items-center rounded-md px-3">{{trans('index.Repurchase')}}</a>
