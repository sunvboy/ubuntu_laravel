...
@section('title')
<title>Cập nhập hãng vận chuyển</title>
@endsection
@section('breadcrumb')
<?php
$array = array(
    [
        "title" => "Cập nhập hãng vận chuyển",
...
<div class="content">
    <div class=" flex items-center mt-8">
        <h1 class="text-lg font-medium mr-auto">
            Cập nhập hãng vận chuyển
        </h1>
    </div>
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('ships.update', ['id' => $detail->id])}}" method="post" enctype="multipart/form-data">
