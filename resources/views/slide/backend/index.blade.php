                    ...
                    <ul class="folder-list" id="folder-list" style="padding: 0">
                        ...
                        <li class="mt-2">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <a type="button" class="slide-group-edit text-danger mr-2" href="javascript:void(0)" data-id="{{$v->id}}" data-title="{{$v->title}}" data-bs-toggle="modal" data-bs-target="#basic-modal-edit-group"> Sửa</a>
                                    @if(env('APP_ENV') == "local")
