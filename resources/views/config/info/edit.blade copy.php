...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('config_infos.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">
