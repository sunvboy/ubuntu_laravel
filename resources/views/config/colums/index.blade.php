    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="d-flex justify-content-end p-2">
                ...
                <a href="{{route('config_colums.create')}}" class="btn btn-primary btn-label waves-effect waves-light">
