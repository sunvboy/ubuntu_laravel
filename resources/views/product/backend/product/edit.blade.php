...
<form role="form" action="{{route('products.update',['id' => $detail->id ])}}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row mt-3">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab4" role="tabpanel">
                            @include('product.backend.product.common.price',['action' => 'update'])
                        </div>
                    </div>
                </div><!-- end card-body -->
                <div class="card-body">
