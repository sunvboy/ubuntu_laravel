    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('websites.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">
        ...
        <div class="col-span-4">
            <div class="box p-5 pt-3">
                ...
                <img src="<?php echo !empty($detail->image) ? url($detail->image) :  asset('images/404.png'); ?>" id="mainThmb-image" class="'w-full" style="width:100%;height:270px;object-fit: cover;">
                <input type="text" value="<?php echo !empty($detail->image) ? $detail->image : ''; ?>" name="image_old" class="w-full " id="image_old">
