...
function tConvert(e) {
  e = new Date(e);
  var t = (e = (time_s = e.getHours() + ":" + e.getMinutes()).split(":"))[0],
    a = 12 <= t ? "PM" : "AM";
  return (
    (t = (t %= 12) || 12) + ":" + ((e = e[1]) < 10 ? "0" + e : e) + " " + a
  );
}
var invoice_new_obj,
  str_dt = function (e) {
  ...
  Invoices = [
    {
      invoice_no: "2",
      img: "sa.jpg",
      customer: "Sả Tươi 100G",

      
      deutsch: "Zitronengras 100g",
      invoice_amount:10.8,
      gesamt:"21.60",
    ...
    },
    {
        invoice_no: "1.2",
        img: "cugieng.jpg",
        customer: "Củ Riềng 200",
        deutsch: "Galgant 200g",
        invoice_amount:16.20,    
        gesamt:"19.44",  
        date: new Date(2021, 3, d - 23, 21, 58),
      status: "Paid",
      billing_address: {
    ...
    },
    {
        invoice_no: "2",
        img: "daudua.jpg",
        customer: "Đậu Đũa 200g",
        deutsch: "Lange Bohnen 200g",
        invoice_amount:16.00,    
        gesamt:"32.00",  
        date: new Date(2021, 3, d - 23, 21, 58),
      status: "Paid",
    ...
    },
    {
        invoice_no: "0.5",
        img: "hanhkho.webp",
        customer: "Hành Khô 100",
        deutsch: "Getrocknet Zwiebeln",
        invoice_amount:16.20,    
        gesamt:"8.10",  
        date: new Date(2021, 3, d - 23, 21, 58),
      status: "Paid",
    ...
    },
    {
        invoice_no: "0.8",
        img: "canuoc.jpg",
        customer: "Cần Nước 200G",
        deutsch: "viet. Sellerie 200g",
        invoice_amount:16.20,    
        gesamt:"12.96",  
        date: new Date(2021, 3, d - 23, 21, 58),
      status: "Paid",
    ...
    },
    {
        ...
        img: "muitau.jpg",
        customer: "Mùi Tàu",
        deutsch: "Lange Koriander",
        invoice_amount:16.90,    
        gesamt:"16.90",  
        date: new Date(2021, 3, d - 23, 21, 58),
      status: "Paid",
      billing_address: {
    ...
    },
    {
        ...
        img: "kapao.jpg",
        customer: "Pay Kapao",
        deutsch: "Scharfe Basilikum",
        invoice_amount:18.50,    
        gesamt:"46.35",  
        date: new Date(2021, 3, d - 23, 21, 58),
      status: "Paid",
      billing_address: {
    ...
    },
    {
        ...
        img: "rauma.jpg",
        customer: "Rau Má",
        deutsch: "Pennywortblätter",
        invoice_amount:16.25,    
        gesamt:"8.25",  
        date: new Date(2021, 3, d - 23, 21, 58),
      status: "Paid",
      billing_address: {
        ...
        `<tr>\n   
            <th scope="row">\n
               <div class="form-check">\n
                     <input class="form-check-input" type="checkbox" name="chk_child" value="${e.invoice_no}">\n 
                </div>\n 
            </th>\n
           <td class="id" style="display:none">
              <a href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="` + e.invoice_no +'" class="fw-medium link-primary">' +
               e.invoice_no +
              '</a></td>\n  <td class="customer_name">\n                    <div class="d-flex align-items-center">\n                        ' +
        a +
        e.customer +
        '\n                    </div>\n      <td class="Deutsch">' + e.deutsch + '</td>\n   <td class="menge">' +
        e.invoice_no +
...
function updateList() {
  var e = document.querySelector("input[name=status]:checked").value;
  (data = userList.filter(function (t) {
    return "All" == e || t.values().sts == e;
  })),
    userList.update();
}
...
function SearchData() {
  var e = document.getElementById("idStatus").value,
    t = document.getElementById("datepicker-range").value,
    a = t.split(" to ")[0],
    n = t.split(" to ")[1];
  invoiceList.filter(function (i) {
    var o = (matchData = new DOMParser().parseFromString(
        i.values().status,
        "text/html"
      )).body.firstElementChild.innerHTML,
      r = "all" == o || "all" == e || o == e,
      s =
        new Date(i.values().date.slice(0, 12)) >= new Date(a) &&
        new Date(i.values().date.slice(0, 12)) <= new Date(n);
    return (r && s) || (r && "" == t ? r : s && "" == t ? s : void 0);
  }),
    invoiceList.update();
}
function ischeckboxcheck() {
  Array.from(document.getElementsByName("chk_child")).forEach(function (e) {
    e.addEventListener("change", function (t) {
      1 == e.checked
        ? t.target.closest("tr").classList.add("table-active")
        : t.target.closest("tr").classList.remove("table-active");
      var a = document.querySelectorAll('[name="chk_child"]:checked').length;
      t.target.closest("tr").classList.contains("table-active"),
        (document.getElementById("remove-actions").style.display =
          0 < a ? "block" : "none");
    });
  });
