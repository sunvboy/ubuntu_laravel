...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        //end
        $seo['meta_title'] = "Dashboard";
        return view('dashboard.home.index', compact('module', 'seo', 'dropdown', 'totalProduct', 'totalArticle', 'totalContact', 'data',  'totalOrder', 'returnStatus', 'returnStatusCount', 'topProductPayment'));
    }
