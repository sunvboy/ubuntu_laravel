...
if (!function_exists('dropdownOne')) {

    function dropdownOne($data = [], $key = '', $value = '')
    {
        if (!empty($data)) {
            foreach ($data as $item) {
...
if (!function_exists('dropdownOneDeault')) {

    function dropdownOneDeault($data = [], $title = 'Select', $key = '', $value = '')
    {
        if (!empty($title)) {
            $return['0'] = $title;
        }
